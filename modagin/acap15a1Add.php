...
if( !empty($regisroUID) && !empty($uidFormulario) ) {
    ...
    $sql = "SELECT * FROM frm3_cap15_productosterminados WHERE prod_regi_uid = '".$regisroUID."' AND prod_tima_uid = '".$prod_tima_uid."' AND prod_position <> 0 ";          
    $db2->query($sql);
    $aPosition = array();
    ...
    for( $pos = 1; $pos<=$maxrow; $pos++ ) {
        ...
        if( !in_array($pos, $aPosition) ) {                        
            ...
            if( !empty($desc) ) {                                
                $sql  = "INSERT frm3_cap15_productosterminados SET ";
    ...
    // totales
    $uidtotalmateria = 10;
    $sql = "SELECT prod_uid FROM frm3_cap15_productosterminados WHERE prod_position = '0' AND prod_tima_uid = '".$uidtotalmateria."' AND prod_regi_uid = '".$regisroUID."' ";
    $db->query( $sql );
