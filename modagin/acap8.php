...
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm3_cap8_ingresosopera SET ";
...
$sql = " SELECT frm3_cap8_ingresosopera.*, adm_definiciones.defi_subcapitulo as subcap "
      ." FROM  frm3_cap8_ingresosopera LEFT JOIN  adm_definiciones ON ( inop_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(3,'A',8,0); ?></td>
        </tr>
    </tbody>
    </table>        
