        ...
        <fieldset>          
          <table width="95%">
                ...
                <tr>
                    ...
                    <td width="20%" align="right"  ><input type="text" name="prima-71" id="prima-71" size="10" class="inpBX" /><span id="div_prima-71" class="bxEr" style="display:none" >requerido</span></td>
                    <td width="20%" align="right"  ><input type="text" name="prima-81" id="prima-81" size="10" class="inpBX" /><span id="div_prima-81" class="bxEr" style="display:none" >requerido</span></td>
                ...
                <tr>
                  ...
                  <td align="right"  ><input type="text" name="aux-71" id="aux-71" size="10" class="inpBX" /><span id="div_aux-71" class="bxEr" style="display:none" >requerido</span></td>
                  <td align="right"  ><input type="text" name="aux-81" id="aux-81" size="10" class="inpBX" /><span id="div_aux-81" class="bxEr" style="display:none" >requerido</span></td>
