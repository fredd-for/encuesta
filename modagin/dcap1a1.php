...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(3,'D',1,1); ?></td>
        </tr>
    </tbody>
    </table>        
    ...
    <form class="formA validable" action="dcap1a1Add.php" method="post" autocomplete="off" >
      <fieldset>    
          ...
          <table width="100%" class="fOpt" id="table_a" >
                ...
                <tbody>
                <?php
                $posmax = OPERATOR::getDbValue("SELECT MAX(capa_position) + 1 as pos FROM frm3_dcap1a_capacitacion WHERE capa_regi_uid = '".$regisroUID."' AND capa_defi_uid = '513' AND capa_position <> 0");                
                if( empty($posmax) ) { $posmax = 1; }
                $sql3 = "SELECT * FROM frm3_dcap1a_capacitacion WHERE capa_defi_uid = '513' AND capa_regi_uid = '".$regisroUID."' AND capa_delete = 0 AND capa_position <> 0 ORDER BY capa_position ASC ";
                ...
                <tr id="rowa_<?php echo $pos; ?>" >
                    ...
                    <td width="6%" ><input type="text" name="C_<?php echo $pos ?>" id="C_<?php echo $pos ?>" value="<?php echo $aDat["capa_institucion"] ?>"  size="40" class="inpC2" onblur="saveUPD(1);" /></td>
...
<!-- table 1 --> 
          ...
          <table width="100%" class="fOpt" id="table_b" >
                ...
                <tbody>
                <?php
                $posmax = OPERATOR::getDbValue("SELECT MAX(capa_position) + 1 as pos FROM frm3_dcap1a_capacitacion WHERE capa_regi_uid = '".$regisroUID."' AND capa_defi_uid = '514' AND capa_position <> 0");                
                if( empty($posmax) ) { $posmax = 1; }
                $sql3 = "SELECT * FROM frm3_dcap1a_capacitacion WHERE capa_defi_uid = '514' AND capa_regi_uid = '".$regisroUID."' AND capa_delete = 0 AND capa_position <> 0 ORDER BY capa_position ASC ";
                ...
                <tr id="rowb_<?php echo $pos; ?>" >
                    ...
                    <td width="6%" ><input type="text" name="C2_<?php echo $pos ?>" id="C2_<?php echo $pos ?>" value="<?php echo $aDat["capa_institucion"] ?>"  size="40" class="inpC2" onblur="saveUPD(2);" /></td>
        ...
        <tbody>
                <?php
                $posmax = OPERATOR::getDbValue("SELECT MAX(capa_position) + 1 as pos FROM frm3_dcap1a_capacitacion WHERE capa_regi_uid = '".$regisroUID."' AND capa_defi_uid = '515' AND capa_position <> 0");                
                if( empty($posmax) ) { $posmax = 1; }
                $sql3 = "SELECT * FROM frm3_dcap1a_capacitacion WHERE capa_defi_uid = '515' AND capa_regi_uid = '".$regisroUID."' AND capa_delete = 0 AND capa_position <> 0 ORDER BY capa_position ASC ";                
                ...
                <tr id="rowc_<?php echo $pos; ?>" >
                    ...
                    <td width="6%" ><input type="text" name="C3_<?php echo $pos ?>" id="C3_<?php echo $pos ?>" value="<?php echo $aDat["capa_institucion"] ?>"  size="40" class="inpC2" onblur="saveUPD(3);" /></td>
