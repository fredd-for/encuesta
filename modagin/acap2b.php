...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(3,'A',2,2); ?></td>
        </tr>
    </tbody>
    </table>        
      ...
      <fieldset>
            ...
            <table width="100%" class="fOpt" >
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A3" id="A3" value="<?php echo number_format($aSueldos["otpa_valor"]) ?>" onblur="saveUPD(1);" size="20" maxlength="15" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    ...
                    <input type="text" name="A6" id="A6" value="<?php echo number_format($aSueldos["otpa_valor"]) ?>" onblur="saveUPD(1);" maxlength="15" size="20" class="inpB2 numeric" /></td>
                </tr>
                <?php
