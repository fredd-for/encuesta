...
if( $db->numrows() == 0 ) {
    ...
    $sql2 = "SELECT * FROM adm_definiciones WHERE defi_form_uid = '3' AND defi_modulo = 'c' AND  defi_capitulo = '1' AND defi_swactive = 'ACTIVE' ";       
    $db2->query( $sql2 );
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm3_ccap1_usoaccesotic SET ";
...
<fieldset>
    ...
    <?php
    $sql = " SELECT frm3_ccap1_usoaccesotic.*, adm_definiciones.defi_subcapitulo as subcap, adm_definiciones.defi_indent as indent, adm_definiciones.defi_vinieta as vinieta "
          ." FROM frm3_ccap1_usoaccesotic LEFT JOIN  adm_definiciones ON ( usac_defi_uid = defi_uid ) "
    ...
    <?php } ?>
     ...
     <p>&nbsp;</p>
     <p>
         <span class="subT">USO DE TECNOLOG&Iacute;AS DE INFORMACI&Oacute;N Y COMUNICACI&Oacute;N</span>
     </p>
     <p>
     ...
     <p>   
        ...
        <?php if( $aDat["usac_valor"] == 1 ) { $mostrar2 = "style=\"display:block;\"";  } else { $mostrar2 = "style=\"display:none;\""; }?>
        <input class="inpC" name="ancho_otro" type="text" onblur="saveUPD(1);" id="ancho_otro" size="60" <?php echo $mostrar2; ?> value="<?php echo $aDat["usac_description"]; ?>"  />              
