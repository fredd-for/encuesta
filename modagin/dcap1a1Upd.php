...
if( !empty($regisroUID) && !empty($uidFormulario) ) {
    ...
    $reg = $tabla;    
    switch( $tabla ){
        case 1: $reg = ""; $pmax = "a"; $capa_defi_uid = 513; break; // áreas tecnicas
        case 2: $pmax = "b"; $capa_defi_uid = 514; break; // gestion empresarial
        case 3: $pmax = "c"; $capa_defi_uid = 515; break; // capacidades personales
    }
