...
$data[326] = preg_replace('/,/', '', $a1);

$a2 = OPERATOR::toSql(safeHTML(OPERATOR::getParam("A2")),'Text');
$data[327] = preg_replace('/,/', '', $a2);

$a3 = OPERATOR::toSql(safeHTML(OPERATOR::getParam("A3")),'Text');
$data[328] = preg_replace('/,/', '', $a3);

$desc[328] = OPERATOR::toSql(safeHTML(OPERATOR::getParam("A7")),'Text');

$data[329] = $data[326] + $data[327] + $data[328];
