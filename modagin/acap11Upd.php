...
if( !empty($regisroUID)  ) {
    ...
    $activoID = array(404,405,406,407,408,409,410,411);
    ...
    for($i=1; $i<=$nro; $i++){
        ...
        $sql  = "UPDATE frm3_cap11_formacionactivos SET ";
        ...
        $sql .= "foac_otrosdescripcion	 = UPPER('".utf8_decode($description)."'), ";                
    ...
    $sql .= "foac_suv_uid = '".$uid_token."', ";
    $sql .= "foac_updatedate = NOW() ";
    $sql .= "WHERE foac_regi_uid = '".$regisroUID."' AND foac_defi_uid = '412' ";         
    $db2->query($sql);
