$(document).ready( function() {                
    ...
    $("#sendData").click( function(){       
        var tot = formatinteger( $("#totTL").text() );
...
function sumcol( columna, fila ){
    ...
    /* sum total cantidadIF = totd + totf - toth; */
    ...
    var totc, totd, totf, toth, tote, totg, toti, totj, totk, cantidadIF, valorIF, cantcomp;
    ...
    //cantcomp = tote + totf;
    //$("#totTG").text( number_format(cantcomp,0,'',',') );
    
    cantcomp = totc + tote + totf - toti;
    $("#totTK").text( number_format(cantcomp,0,'',',') );
    
    cantcomp = totd + toth - totj;
    $("#totTL").text( number_format(cantcomp,0,'',',') );
    $("#msg3").hide();
