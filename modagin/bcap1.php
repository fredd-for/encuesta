...
if( $db->numrows() == 0 ) {
    ...
    $sql2 = "SELECT * FROM adm_definiciones WHERE defi_form_uid = '3' AND defi_modulo = 'b' AND defi_capitulo = '1' AND defi_swactive = 'ACTIVE' ";       
    $db2->query( $sql2 );
...
<?php            
    ...
    $sql = " SELECT frm3_bcap1_gestionambiental.*, adm_definiciones.defi_subcapitulo as subcap, adm_definiciones.defi_indent as indent, adm_definiciones.defi_vinieta as vinieta "
          ." FROM frm3_bcap1_gestionambiental LEFT JOIN  adm_definiciones ON ( geam_defi_uid = defi_uid ) "
          ." WHERE geam_regi_uid = '".$regisroUID."' AND geam_defi_uid IN (423, 424, 425, 435, 436, 437 )  "
    ...
    $sql = " SELECT frm3_bcap1_gestionambiental.*, adm_definiciones.defi_subcapitulo as subcap, adm_definiciones.defi_indent as indent, adm_definiciones.defi_vinieta as vinieta  "
          ." FROM frm3_bcap1_gestionambiental LEFT JOIN adm_definiciones ON ( geam_defi_uid = defi_uid ) "
          ." WHERE geam_regi_uid = '".$regisroUID."' AND geam_defi_uid NOT IN (423, 424, 425, 435, 436, 437 ) "
...
<div class="content">
    ...
    <form class="formA validable" action="bcap1Add.php" method="post" autocomplete="off" >
        <fieldset>
            ...
            <p>
            <?php //echo OPERATOR::getDescTitles(3,'B',1,'1.1'); ?>
            <?php echo OPERATOR::getDescTitles(3,'B',1,'1.2'); ?>
            </p>
            <p>
            ...
            <p>
                <?php echo OPERATOR::getDescTitles(3,'B',1,'2'); ?>                
            </p>
            <p>
            ...
            <p><?php echo OPERATOR::getDescTitles(3,'B',1,3); ?></p>
            <p> 
            ...
            <p><?php echo OPERATOR::getDescTitles(3,'B',1,'5'); ?></p>
            <p> 
            ...
            <p><?php echo OPERATOR::getDescTitles(3,'B',1,'6'); ?></p>
            <p> 
