...
if( $db->numrows() == 0 ) {
    ...
    $sql2 = "SELECT * FROM adm_definiciones WHERE defi_form_uid = '3' AND defi_modulo = 'b' AND defi_capitulo = '3' AND defi_swactive = 'ACTIVE' ";       
    $db2->query( $sql2 );
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO  frm3_bcap3_responsocial SET ";
...
<?php            
    ...
    $sql = " SELECT  frm3_bcap3_responsocial.*, adm_definiciones.defi_subcapitulo as subcap, adm_definiciones.defi_indent as indent, adm_definiciones.defi_vinieta as vinieta  "
          ." FROM  frm3_bcap3_responsocial LEFT JOIN adm_definiciones ON ( reso_defi_uid = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr><td colspan="2"><?php echo OPERATOR::getDescTitles(3,'B',3,'0'); ?></td></tr>
    </tbody>
    </table>
