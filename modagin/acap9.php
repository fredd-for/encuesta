...
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm3_cap9_ingresosnoopera SET ";
...
$sql = " SELECT  frm3_cap9_ingresosnoopera.*, adm_definiciones.defi_subcapitulo as subcap "
      ." FROM  frm3_cap9_ingresosnoopera LEFT JOIN  adm_definiciones ON ( inno_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(3,'A',9,0); ?></td>
        </tr>
    </tbody>
    </table>        
