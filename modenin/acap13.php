...
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm2_cap13_otrosinventarios SET ";
...
$sql = " SELECT frm2_cap13_otrosinventarios.*, adm_definiciones.defi_subcapitulo as subcap "
      ." FROM  frm2_cap13_otrosinventarios LEFT JOIN  adm_definiciones ON ( otin_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',13,0); ?></td>
        </tr>
    </tbody>
    </table>        
