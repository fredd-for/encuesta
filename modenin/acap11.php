...
$sql = "SELECT * FROM  frm2_cap11_formacionactivos WHERE foac_regi_uid = '".$regisroUID."' ";
$db->query( $sql );
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm2_cap11_formacionactivos SET ";
...
$sql = " SELECT  frm2_cap11_formacionactivos.*, adm_definiciones.defi_subcapitulo as subcap "
      ." FROM  frm2_cap11_formacionactivos LEFT JOIN  adm_definiciones ON ( foac_defi_uid	 = defi_uid ) "
...
<div class="content">            
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',11,0); ?></td>
        </tr>
    </tbody>
    </table>
        ...
        <fieldset>         
          <table width="100%" class="fOpt" >
                ...
                <tr>
                    ...
                    <td align="right"  ><input type="text" value="<?php echo number_format($aDat["foac_depreciacion"]); ?>" name="input-72" id="input-72" size="6" class="inpB2 numeric"  /></td>
                </tr>
                <?php } ?>
