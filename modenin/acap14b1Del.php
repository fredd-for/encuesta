...
$sql = " UPDATE frm2_cap14b_materiasprimas SET mapr_delete = 1 "
...
$sql = "SELECT * FROM frm2_cap14b_materiasprimas WHERE mapr_position = '".$uid."' AND mapr_tima_uid = '".$mapr_tima_uid."' AND mapr_regi_uid = '".$regisroUID."' ";
$db->query( $sql );
$aDat = $db->next_record();

// total materia prima
$uidtotalmateria = 4;
$sql = "SELECT * FROM frm2_cap14b_materiasprimas WHERE mapr_position = '0' AND mapr_tima_uid = '".$uidtotalmateria."' AND mapr_regi_uid = '".$regisroUID."' ";
$db->query( $sql );
