...
switch ( $reg  ){
    case 'a': $capa_defi_uid = 292; break;        
}
...
$sql = "SELECT SUM(capa_valor) as tot FROM frm2_dcap1a_capacitacion WHERE capa_regi_uid = '".$regisroUID."' AND capa_defi_uid = '".$capa_defi_uid."' AND capa_delete = 0 ";
...
$sql = " UPDATE frm2_dcap1a_capacitacion SET capa_valor = '".$totalExistente."', capa_suv_uid = '".$uid_token."', capa_updatedate = NOW() "
      ." WHERE capa_regi_uid = '".$regisroUID."' AND capa_defi_uid = '309'  ";
$db->query( $sql );
