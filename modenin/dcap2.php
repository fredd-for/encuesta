...
if( $db->numrows() == 0 ) {
    ...
    $sql2 = "SELECT * FROM adm_definiciones WHERE defi_form_uid = '2' AND defi_modulo = 'd' AND  defi_capitulo = '2' AND defi_swactive = 'ACTIVE' ";       
    $db2->query( $sql2 );
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm2_dcap2_inversion SET ";
...
$sql = " SELECT  frm2_dcap2_inversion.*, adm_definiciones.defi_subcapitulo as subcap "
      ." FROM  frm2_dcap2_inversion LEFT JOIN  adm_definiciones ON ( inve_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>
            <td colspan="2" ><?php echo OPERATOR::getDescTitles(2,'D',2,0); ?></td>
        </tr>
    </tbody>
    </table>
