...
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm2_cap4_otrosgastosoperativos SET ";
...
$sql = " SELECT  frm2_cap4_otrosgastosoperativos.*, adm_definiciones.defi_indent as indent "
      ." FROM  frm2_cap4_otrosgastosoperativos LEFT JOIN  adm_definiciones ON ( otga_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',4,0); ?></td>
        </tr>
    </tbody>
    </table>        
