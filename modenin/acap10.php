...
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm2_cap10_resultadogestion SET ";
...
$sql = " SELECT  frm2_cap10_resultadogestion.*, adm_definiciones.defi_subcapitulo as subcap "
      ." FROM  frm2_cap10_resultadogestion LEFT JOIN  adm_definiciones ON ( rege_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',10,0); ?></td>
        </tr>
    </tbody>
    </table>        
