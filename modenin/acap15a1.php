...
<script type="text/javascript" src="js/acap15a_1.js"></script>
<?php 
/* usuario */
...
<div class="content">
    ...
    <form class="formA validable" action="acap15a1Add.php" method="post" autocomplete="off" >
      <fieldset>                          
          <p> <span class="subT">PRODUCTOS</span></p>
          <table width="100%" class="fOpt" id="tablecertificacion" >
                <thead>
                <tr>
                  <td rowspan="2" align="center" >DESCRIPCI&Oacute;N DE PRODUCTOS</td>
                ...
                <tbody>
                <?php
                $posmax = OPERATOR::getDbValue("SELECT MAX(prod_position) + 1 as pos FROM frm2_cap15_productosterminados WHERE prod_regi_uid = '".$regisroUID."' AND  prod_tima_uid = '7' AND prod_position <> 0");
                if( empty($posmax) ) { $posmax = 1; }
                
                $sql3 = "SELECT * FROM frm2_cap15_productosterminados WHERE prod_regi_uid = '".$regisroUID."' AND prod_delete = 0 AND prod_position <> 0 AND prod_tima_uid = '7' ORDER BY prod_position ASC  ";
                //echo $sql3;
            ...
            <a href="acap14b3.php" class="btnS">ANTERIOR</a>                
            </span>
