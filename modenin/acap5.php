...
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm2_cap5_materiaprima SET ";
...
$sql = " SELECT  frm2_cap5_materiaprima.*, adm_definiciones.defi_vinieta as vinieta "
      ." FROM  frm2_cap5_materiaprima LEFT JOIN  adm_definiciones ON ( mapi_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',5,0); ?></td>
        </tr>
    </tbody>
    </table>        
