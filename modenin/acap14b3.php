...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',14,'b1'); ?></td>
        </tr>
    </tbody>
    </table>        
      ...
      <fieldset>                          
          ...
          <table width="100%" class="fOpt" id="tablecertificacion" >
                ...
                <tr>
                  ...
                  <td rowspan="2" align="center" >ACTIVIDAD DEL PRINCIPAL PROVEEDOR</td>
                ...
                <tbody>
                <?php
                $posmax = OPERATOR::getDbValue("SELECT MAX(mapr_position) + 1 as pos FROM frm2_cap14b_materiasprimas WHERE mapr_regi_uid = '".$regisroUID."' AND  mapr_tima_uid = '3' AND mapr_position <> 0");
                if( empty($posmax) ) { $posmax = 1; }
                
                $sql3 = "SELECT * FROM frm2_cap14b_materiasprimas WHERE mapr_regi_uid = '".$regisroUID."' AND mapr_delete = 0 AND mapr_tima_uid = '3' ORDER BY mapr_position ASC  ";
                //echo $sql3;
                ...
                $sql = "SELECT
                        ...
                        FROM frm2_cap14b_materiasprimas WHERE mapr_regi_uid = '".$regisroUID."' AND mapr_delete = 0 AND mapr_tima_uid IN (1,2,3) AND mapr_position <> 0 GROUP BY mapr_regi_uid";
                $db3->query( $sql );                
            ...
            <?php 
            $sql = "SELECT mapi_valor FROM  frm2_cap5_materiaprima WHERE mapi_regi_uid = '".$regisroUID."' AND mapi_defi_uid	 = 156 ";
            $db2->query( $sql );
            ...
            <p>
                ...
                <!-- <span id="msg3" style="display: none;" class="bxEr"  >El valor total de la columna de "inventario final" debe se igual a Bs. <span id="Tt"><?php // echo number_format($aTotCap5["mapi_valor"]);  ?></span></span> -->
                <span id="msg3" style="display: none;" class="bxEr"  >El valor total de la columna de "inventario final" debe se mayor a cero </span>
            </p>
            
            
            <!-- <p>
                El <b>valor</b> total de la columna de "inventario final" debe se igual a Bs. <b><?php // echo number_format($aTotCap5["mapi_valor"]);  ?></b> 
            ...
            <p><?php echo OPERATOR::getDescTitles(2,'A',14,'b2'); ?></p>
            <span class="bxBt">
