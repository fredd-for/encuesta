...
if( $db->numrows() == 0 ) {
    ...
    while( $aDefinicion =  $db2->next_record() ) {
        $sql = "INSERT INTO frm2_cap7_mercaderias SET ";
...
$sql = " SELECT  frm2_cap7_mercaderias.*, adm_definiciones.defi_subcapitulo	 as subcap "
      ." FROM  frm2_cap7_mercaderias LEFT JOIN  adm_definiciones ON ( merc_defi_uid	 = defi_uid ) "
...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',7,0); ?></td>
        </tr>
    </tbody>
    </table>        
    ...
    <form class="formA validable" action="acap7Add.php" method="post" autocomplete="off" >
      <fieldset>        
        <table width="100%" class="fOpt" >
            ...
            <p>
                <?php echo OPERATOR::getDescTitles(2,'A',7,7); ?>
            </p>
