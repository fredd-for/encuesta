$(document).ready( function() {                
    ...
    $("#sendData").click( function(){       
        var totL = formatinteger( $("#totTL").text() );
        var totM = formatinteger( $("#totTM").text() );        
        if( totL == 0 || totM == 0 ) {
            $("#msg3").show();
            return false;
        }        
...
function sumcol( columna, fila ){
   ...
   var sum = 0, sumL = 0, sumM = 0;
    ...
    var totd, totf, toth, tote, totg, toti, totj, totk, cantidadIF, valorIF;
    totd = formatinteger( $("#totTD").text() );
    totf = formatinteger( $("#totTF").text() );
    toth = formatinteger( $("#totTH").text() );
    totj = formatinteger( $("#totTJ").text() );
    cantidadIF = totd - totf - toth + totj;
        
    tote = formatinteger( $("#totTE").text() );
    totg = formatinteger( $("#totTG").text() );
    toti = formatinteger( $("#totTI").text() );
    totk = formatinteger( $("#totTK").text() );
    valorIF = tote - totg - toti + totk;
    
    $("#totTL").text( number_format(cantidadIF,0,'',',') );
    $("#totTM").text( number_format(valorIF,0,'',',') );
...
function delRow( numero, sw ) {
    ...
    td = td - x; $("#totTJ").text( number_format(td,0,'',',') );
    ...
    td = td - x; $("#totTK").text( number_format(td,0,'',',') );
    
    
    var tl = 0, tm = 0;
    tl = formatinteger( $("#totL_"+numero).text());
    tm = formatinteger( $("#totM_"+numero).text());

    td = formatinteger( $("#totTL").text());
    td = td - tl;
    $("#totTL").text( number_format(td,0,'',',') );

    td = formatinteger( $("#totTM").text());
    td = td - tm;
    $("#totTM").text( number_format(td,0,'',',') );
