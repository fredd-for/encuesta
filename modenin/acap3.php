...
<div class="content ">                
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(2,'A',3,0); ?></td>
        </tr>
    </tbody>
    </table>
              ...
              <thead>
               ...
               <?php if( $aSuministro["vinieta"] == 1 ) { ?>
                <tr>
                    ...
                    <input type="text" name="input-1" id="input-1" value="<?php echo $aSuministro["sumi_valor"] ?>" size="20"  class="inpB2 numeric">
                    ...
                    <?php
                        ...
                        $db2->query( $sqlTarifa );                        
                    ?>
                    <select name="input-11" id="input-11" onchange="showInputOtro('electricidad'); return false;" >
                ...
                <tr>
                    ...
                    <td align="center"  ><input type="text" name="otrogas" id="otrogas" class="inpC2 alphanum" onblur="javascript:saveUPD(3); return false;" value="<?php echo $tipotarifamostrar; ?>"  <?php echo $mostrar1; ?> /></td>
                </tr>
                <?php } ?>
