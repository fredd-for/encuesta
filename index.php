                    ...
                    if( $status == 1 ) {
                     ...
                     <?php if( !empty($_GET["act"]) ){ 
                        ...
                        switch ( $status ) {
                            ...
                            case 3: $messg = "<span class=\"txtR\">El n&uacute;mero de matricula es incorrecto &oacute; Existi&oacute; un problema en la comunicaci&oacute;n por favor intente mas tarde.</span>"; break;
