$(document).ready( function() {    
    ...
    $("#sendData").click( function() {                                     
        ...
        var prog1IsChecked = document.getElementById("prog_1").checked
        if( prog1IsChecked ) {                        
        ...
        var prog2IsChecked = document.getElementById("prog_2").checked
        if( prog2IsChecked ) {
