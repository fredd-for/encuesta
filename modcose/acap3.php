...
<div class="content ">                
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><?php echo OPERATOR::getDescTitles(1,'A',3,0); ?></td>
        </tr>
    </tbody>
    </table>
              ...
              <thead>
               ...
               <?php if( $aSuministro["vinieta"] == 1 ) { ?>
                ...
                <tr>
                    ...
                    <td align="right"  ><input type="text" onblur="javascript:saveUPD(2); return false;" name="input-2" id="input-2" value="<?php echo $aSuministro["sumi_valor"] ?>" size="20" class="inpB2 numeric">
                ...
                <tr>
                    ...
                    <td align="right"  ><input type="text" onblur="javascript:saveUPD(3); return false;" name="input-3" id="input-3" value="<?php echo $aSuministro["sumi_valor"] ?>" size="20" class="inpB2 numeric">
                    ...
                    <td align="center"  ><input type="text" name="otrogas" id="otrogas" class="inpC2 alphanum" value="<?php echo $tipotarifamostrar; ?>"  <?php echo $mostrar1; ?> /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    ...
                    <td align="right"  >
                    <input type="text" name="input-5" id="input-5" value="<?php echo $aSuministro["sumi_valor"] ?>" size="20" class="inpB2 numeric">
                ...
                <tr>
                    ...
                    ?>
                    <input type="text" name="input-9" id="input-9" value="<?php echo $aSuministro["sumi_categoriatarifaria"] ?>" <?php echo $mostrar; ?>  size="30" class="inpC2">                    
